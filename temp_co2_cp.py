...
class CO2Calculator:
    ...
    def _compute_coldroom_parameters(self):
        ...
        if weight_fruit_crate == 0 or crates_per_storage == 0 or daily_wattage == 0 or Cp_water == 0:
            return
        ...
        if daily_wattage > 0:
            ...
            self.room_thermal_properties.EC_iceblock = 0
        ...
        self.room_electricity_management.electricity_cooling_fruit = (
            ...
            if self.crop.EC_fruit != 0 else 0
        )
        ...
        self.room_electricity_management.electricity_iceblock_produced = (
            ...
            if self.room_thermal_properties.EC_iceblock != 0 else 0
        )
